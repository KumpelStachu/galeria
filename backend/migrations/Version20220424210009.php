 ...
 */
final class Version20220424210009 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE comment (id INT NOT NULL, profile_id INT NOT NULL, gallery_id INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, content VARCHAR(320) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE gallery (id INT NOT NULL, profile_id INT NOT NULL, title VARCHAR(320) NOT NULL, nsfw BOOLEAN NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE image (id INT NOT NULL, profile_id INT NOT NULL, gallery_id INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE profile (id INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, username VARCHAR(30) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, description VARCHAR(320) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE UNIQUE INDEX UNIQ_8157AA0FF85E0677 ON profile (username)');
        $this->addSql('COMMENT ON COLUMN profile.created_at IS \'(DC2Type:datetimetz_immutable)\'');
        $this->addSql('CREATE TABLE tag (id INT NOT NULL, profile_id INT NOT NULL, created_at TIMESTAMP(0) WITH TIME ZONE NOT NULL, name VARCHAR(100) NOT NULL, PRIMARY KEY(id))');
        $this->addSql('CREATE INDEX IDX_389B783CCFA12B8 ON tag (profile_id)');
        $this->addSql('COMMENT ON COLUMN tag.created_at IS \'(DC2Type:datetimetz_immutable)\'');
