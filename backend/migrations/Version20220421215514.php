 ...
 */
final class Version20220421215514 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comment ALTER created_at TYPE TIMESTAMP(0) WITH TIME ZONE');
        ...
        $this->addSql('ALTER TABLE profile ALTER created_at TYPE TIMESTAMP(0) WITH TIME ZONE');
        $this->addSql('ALTER TABLE profile ALTER created_at DROP DEFAULT');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE profile ALTER created_at TYPE TIMESTAMP(0) WITHOUT TIME ZONE');
        $this->addSql('ALTER TABLE profile ALTER created_at DROP DEFAULT');
